...
- (synthex) wait in-turn during idle loop iterations to avoid Stop-hook noise

## [synthex 1.2.0 / synthex-plus 1.2.0] - 2026-09-21

### Added

- (synthex) install Synthex as a Grok plugin

## [synthex 1.1.0 / synthex-plus 1.1.0] - 2026-09-21

### Added

- (next-priority) add --auto-decide flag for unattended loop runs

## [synthex 1.0.0 / synthex-plus 1.0.0] - 2026-09-20

### Added

- (synthex) support shared Agent Skills harnesses

### Fixed

- (release) preserve staged manifest readability

### Changed

- allow CI filesystem jitter in loop timing check

## [synthex 0.9.10 / synthex-plus 0.5.10] - 2026-06-08

### Fixed

- (synthex) stamp real session id on loop state so the Stop hook drives it

## [synthex 0.9.9 / synthex-plus 0.5.9] - 2026-05-28

### Changed

- (release) raise docs-PR agent --max-turns to 60 and surface failures
...
- (synthex) prevent silent --loop drop-out after one iteration

## [synthex 0.9.5 / synthex-plus 0.5.5] - 2026-05-19

### Fixed

- (release) use valid GitHub-recognized bot email in docs PR commits

## [synthex 0.9.4 / synthex-plus 0.5.4] - 2026-05-17

### Fixed

- (release) replace claude-code-action with direct CLI invocation

## [synthex 0.9.3 / synthex-plus 0.5.3] - 2026-05-17

### Changed

- end-to-end smoke test of cross-repo docs PR agent

## [synthex 0.9.2 / synthex-plus 0.5.2] - 2026-05-17

### Changed

- (release) propose slashsynthex docs PR via Claude agent on release

## [synthex 0.9.1 / synthex-plus 0.5.1] - 2026-05-17

### Changed

- bump GitHub Actions to Node 24 runtime

## [synthex 0.9.0 / synthex-plus 0.5.0] - 2026-05-17

### Added

- (init) write .worktreeinclude template alongside .gitignore
- (onboarding) add /star command and upgrade-time star nudge

### Fixed

- (hooks) resolve SessionStart hook script paths via CLAUDE_PLUGIN_ROOT

### Changed

- (plans) defer worktree built-in-primitive migration

## [synthex 0.8.1 / synthex-plus 0.4.1] - 2026-05-14

### Changed

- archive native-looping plan (shipped in 0.8.0 / 0.4.0)

## [synthex 0.8.0 / synthex-plus 0.4.0] - 2026-05-14

### Added

- (loop) Phase 5 — wire --loop flag into all four synthex-plus team commands
- (loop) Phase 4 — wire --loop flag into iteration-friendly commands
- (loop) Phase 3 — loop-management surface (/list-loops, /cancel-loop, archive spec)
- (loop) Phase 2 — generic /synthex:loop command and gitignore plumbing
- (loop) Phase 1 — implementation plan, iteration-framework spec, and test substrate

### Changed

- (loop) Phase 7 Milestone 7.1 — native looping user-facing documentation
- (loop) Phase 6 Milestone 6.2 — Layer 2 fixtures + promptfoo assertions
- (loop) Phase 6 Milestone 6.1 — Layer 1 schema validators for native looping

## [synthex 0.7.1 / synthex-plus 0.3.2] - 2026-05-08

### Changed

- (claude-md) describe the new automated release workflow
- add release workflow that auto-publishes on merge to main

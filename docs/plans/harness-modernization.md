...
| # | Task | Complexity | Dependencies | Status |
|---|------|-----------|--------------|--------|
| 12 | FR-HM43: ship `plugins/synthex/docs/` in every install (`gemini-activation.mjs:38-53`, `opencode-activation.mjs:17-43`, README l.40, `ADDING_HARNESS.md`). Add `cold-path-includes.test.ts`. Verify D17 expansion and its `plugin_root` fallback. | S | None | in progress |

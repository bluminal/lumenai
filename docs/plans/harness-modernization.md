...
| 13 | FR-HM5 `review-code.md`: Step 1b → `docs/standing-pool-routing.md`, Step 1c → `docs/sandbox-yolo.md`, FR-MR21 Steps 4–8 + complexity gate → `docs/multi-model-decision.md`. The D21 spec and the 3-line FR-MR21 gate stay. | M | Task 12 | in progress |

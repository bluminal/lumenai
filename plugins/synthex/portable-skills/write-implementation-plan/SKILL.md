...
description: "Turn a PRD into a prioritized, parallelizable implementation plan via multi-agent review."
argument-hint: "[requirements_path] [plan_path] [--loop]"
compatibility: "Requires a shell tool; node or jq optional"
metadata:
  short-description: "Turn a PRD into a prioritized, parallelizable implementation plan via multi-agent review."
---
...
1. Read [`./commands/write-implementation-plan.md`](../../commands/write-implementation-plan.md) completely before acting.

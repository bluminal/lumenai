---
name: multi-model-review-orchestrator
...
# Synthex Multi-Model Review Orchestrator
...
1. Read [`./agents/multi-model-review-orchestrator.md`](../../agents/multi-model-review-orchestrator.md) completely before acting.

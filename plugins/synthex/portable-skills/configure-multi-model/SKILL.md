---
name: configure-multi-model
description: "Wizard to enable or reconfigure multi-model code review (fan out to OpenAI, Google, Ollama, etc.)."
argument-hint: "[config_path]"
compatibility: "Requires a shell tool; node or jq optional"
metadata:
  short-description: "Wizard to enable or reconfigure multi-model code review (fan out to OpenAI, Google, Ollama, etc.)."
---

<!-- Generated by scripts/generate-codex-skills.mjs; do not edit. -->

# Synthex Configure Multi-Model Review
...
1. Read [`./commands/configure-multi-model.md`](../../commands/configure-multi-model.md) completely before acting.

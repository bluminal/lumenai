...
argument-hint: "[implementation_plan_path] [--loop]"
compatibility: "Requires a shell tool; node or jq optional"
metadata:
  short-description: "Execute the next highest-priority implementation-plan tasks via the Tech Lead sub-agent."
---
...
1. Read [`./commands/next-priority.md`](../../commands/next-priority.md) completely before acting.

---
name: init
description: "Scaffold .synthex/config.yaml and the docs/reqs, docs/plans, docs/specs directories for a new project."
argument-hint: "[config_path]"
compatibility: "Requires a shell tool; node or jq optional"
metadata:
  short-description: "Scaffold .synthex/config.yaml and the docs/reqs, docs/plans, docs/specs directories for a new project."
---

<!-- Generated by scripts/generate-codex-skills.mjs; do not edit. -->

# Synthex Initialize Synthex
...
1. Read [`./commands/init.md`](../../commands/init.md) completely before acting.

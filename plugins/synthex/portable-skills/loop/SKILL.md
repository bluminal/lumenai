---
name: loop
description: "Run an arbitrary prompt iteratively in this thread until a completion promise or max-iterations."
argument-hint: "--prompt <string> | --prompt-file <path> [--max-iterations <int>]"
compatibility: "Requires a shell tool; node or jq optional"
metadata:
  short-description: "Run an arbitrary prompt iteratively in this thread until a completion promise or max-iterations."
---

<!-- Generated by scripts/generate-codex-skills.mjs; do not edit. -->

# Synthex Loop a prompt natively
...
1. Read [`./commands/loop.md`](../../commands/loop.md) completely before acting.

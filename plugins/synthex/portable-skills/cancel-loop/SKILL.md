---
name: cancel-loop
description: "Mark a running native-looping loop cancelled; polled at the next iteration boundary. Idempotent."
argument-hint: "<loop_id> | --all"
compatibility: "Requires a shell tool; node or jq optional"
metadata:
  short-description: "Mark a running native-looping loop cancelled; polled at the next iteration boundary. Idempotent."
---

<!-- Generated by scripts/generate-codex-skills.mjs; do not edit. -->

# Synthex Cancel one or all native-looping loops
...
1. Read [`./commands/cancel-loop.md`](../../commands/cancel-loop.md) completely before acting.

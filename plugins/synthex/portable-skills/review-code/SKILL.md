---
name: review-code
description: "Run craftsmanship, security, and optional performance review on a diff or file set in parallel."
argument-hint: "[target] [--loop]"
compatibility: "Requires a shell tool; node or jq optional"
metadata:
  short-description: "Run craftsmanship, security, and optional performance review on a diff or file set in parallel."
---
...
1. Read [`./commands/review-code.md`](../../commands/review-code.md) completely before acting.

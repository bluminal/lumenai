...
description: "Audit the frontend for design-token violations, misused components, and accessibility issues."
argument-hint: "[scope]"
compatibility: "Requires a shell tool; node or jq optional"
metadata:
  short-description: "Audit the frontend for design-token violations, misused components, and accessibility issues."
---
